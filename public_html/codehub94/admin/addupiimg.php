...
<div class="main-container">
    ...
    <div class="tab-container">
        <div class="tabs">
            <div class="tab <?php echo (!isset($_GET['tab']) || $_GET['tab']=='method1') ? 'active' : '' ?>" data-tab="method1">Method 1</div>
            <div class="tab <?php echo $_GET['tab']=='method2' ? 'active' : '' ?>" data-tab="method2">Method 2</div>
