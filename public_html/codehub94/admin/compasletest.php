...
<?php } ?>
          ...
          <?php if ($admins == 1 && isset($subRoles['adminss'])) { ?>
  <li class="nav-item">
    ...
    <div class="collapse" id="ui-basic-9">
      <ul class="nav flex-column sub-menu">
        <?php if (in_array('adminpass', $subRoles['adminss'])) { ?>
          <li class="nav-item"> <a class="nav-link" href="adminpass.php">Admin Password</a></li>
        <?php } ?>
        <?php if (in_array('addadmin', $subRoles['adminss'])) { ?>
...
<li class="nav-item">
  ...
  <div class="collapse" id="ui-basic-6">
    <ul class="nav flex-column sub-menu">
      ...
      <?php } ?>
      <?php if (in_array('update_firstdepositbonus', $subRoles['setting'])) { ?>
