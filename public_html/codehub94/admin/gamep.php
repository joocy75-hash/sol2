      ...
      <div class="main-panel">
            ...
            <div class="col-sm-12">
              <div class="table-responsive">
                <table id="yourTable" class="table table-striped">
                  ...
                  <tbody>
                    <?php
                   $sql = "SELECT id, userid, deposit_order_no, bank_account_number, ifsc, order_amount, text_content, remarks, file_upload FROM your_table WHERE prob = 'Game Problems' AND status = 2";
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><a href='https://h5workorder.Sol-0203.com/uploads/" . $row["file_upload"] . "' target='_blank'>" . $row["file_upload"] . "</a></td>";
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © Sol-0203 2025</span>
          </div>
        </footer>
      </div>
    </div>
