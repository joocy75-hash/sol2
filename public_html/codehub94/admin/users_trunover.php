...
// Data fetch
if ($uid > 0) {
    $res = mysqli_query($conn, "SELECT * FROM user_withdraw_summary WHERE user_id = '$uid'");
} else {
    $res = mysqli_query($conn, "SELECT * FROM user_withdraw_summary ORDER BY updated_at DESC LIMIT 1");
}
