...
$query = "SELECT bannerTitle, bannerID, bannerUrl, jumpType, contents FROM table_activity ORDER BY id ASC";
$result = $conn->query($query);

while($row = $result->fetch_assoc()) {
    $data["list"][$i]["bannerTitle"] = $row["bannerTitle"];
    $data["list"][$i]["bannerID"] = $row["bannerID"];
    $data["list"][$i]["bannerUrl"] = $row["bannerUrl"];
    $data["list"][$i]["jumpType"] = (int)$row["jumpType"];
    $data["list"][$i]["contents"] = $row["contents"];
    $i++;
}
